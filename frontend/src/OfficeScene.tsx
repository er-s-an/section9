...
const orangeLab = '/vendor/section9/orange-lab-concept.png'
...
const spriteFor=(id:string)=>id==='sentry'||id==='observer'?1:id==='diagnoser'||id==='investigator'?2:id==='fixer-a'||id==='reviewer'?3:id==='fixer-b'?4:id==='verifier'?2:id==='single'?3:4
